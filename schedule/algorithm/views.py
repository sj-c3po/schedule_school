...
Subjects = {
    ...
    # 79: ['Информатика', 9, 'Колодин', 0, 2, 7, 0, 0.5, 0, 0, 0],
    ...
    # #
    98: ['Музыка', 5, 'Колесник',  0, 1, 1, 0, 0, 0, 0, 0],
    99: ['Музыка', 6, 'Колесник',  0, 1, 1, 0, 0, 0, 0, 0],
    # 100: ['Музыка', 7, 'Колесник',  0, 1, 1, 0, 0, 0, 0, 0],
    # #
...
def generate(request):
    ...
    # new = set_weight_and_sort(Subjects)
    # # Subjects = new
    # print('sjdfhsjdf')
    # print(new)
...
def calculate_the_load(Items):
    ...
    for sclass in list(Classes):
        ...
        copy_list_group_load = copy.deepcopy(list_group_load)
        for l1 in copy_list_group_load:
            if l1 in copy_list_group_load and copy_list_group_load.count(l1) % 2 == 0:
                group_load = group_load+l1
                for i in range(copy_list_group_load.count(l1)):
                    copy_list_group_load.remove(l1)
